    ...
    def _load_face_model(self):
        ...
        try:
            ...
            if self.cascade_detector is not None:
                ...
                logger.info("ℹ️ HumanGuard: Running in standard cloud mode (offline Caffe weights not installed; face gating bypassed)")
        except Exception as e:
            logger.debug(f"HumanGuard Init notice: {e}")
            self.face_net = None
